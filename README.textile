...
This rails application is currently for testing Rails2 plugins. We might create a version for Rails3.
...
h3. Returning to instructions for running the rails application (in development, not testing)
